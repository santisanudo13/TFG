 ...
 * 
 * 		1Âº Call the function pistorms_motor_run_secs(int connector_id, int time)
 * 		2Âº Call the function  pistorms_motor_set_speed(int connector_id,int speed)
 * 		3Âº Call this function pistorms_motor_go(int connector_id, SPEED_GO | TIME_GO)
 * 		
