 ...
 * The Color Sensor measures the intensity of light reflected back from a red lightâ€“emitting lamp.
 ...
 * @param connector_id Bank and Port to plug the sensor.
 * @return  black (1), blue (2), green (3), yellow (4), red (5), white (6), and brown (7) â€”plus No Color (0).
 * 
